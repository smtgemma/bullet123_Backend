...
router.post(
  "/add",
  auth(UserRole.REALTOR, UserRole.ADMIN, UserRole.SUPER_ADMIN,UserRole.COMMUNITY_PARTNER,UserRole.MUNICIPALITY), // Restricted to Realtors and Admins
...
router.get("/my-stories", auth(UserRole.REALTOR, UserRole.ADMIN, UserRole.SUPER_ADMIN,UserRole.COMMUNITY_PARTNER,UserRole.MUNICIPALITY), SuccessStoryController.getMySuccessStories);
